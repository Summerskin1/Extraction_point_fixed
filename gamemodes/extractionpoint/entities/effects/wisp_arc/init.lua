...
function EFFECT:Render()
	...
	local spline = math.QuadraticBezier3D(self.StartPosition, self.StartPosition + self.Angle:Forward() * half + self.Bend:Forward()*half/10 , self.EndPosition)
	render.StartBeam(42);
		...
		for i=0, 40, 1 do
			...
			shift = 400/diff
			render.AddBeam(spline(i/40)+VectorRand()*0.3, self.Thick, 0,  Color((250-shift)*alpha,(220-shift)*alpha*1,(140-shift)*alpha*1.3));
		end
