...
if CLIENT then
   SWEP.PrintName			= "Caltrop Grenade"			
   SWEP.Author				= "Cooldown Studios"
   SWEP.WeaponDesc			= "Toss a caltrop grenade to scatter\nharmful energy pellets on the ground."   
...
SWEP.GrenadeEntity = "ep_caltrop_grenade"
SWEP.UseHands			= true
