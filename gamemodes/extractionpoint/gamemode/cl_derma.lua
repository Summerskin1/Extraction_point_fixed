...
function GFRAME:Paint()
	...
	draw.SimpleTextOutlined(self.Title, "GhostTitle", w/2, 22, highlight_colors.ghost, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 1, font_colors.black)
	return true
end
...
function SFRAME:Paint()
	...
	draw.SimpleTextOutlined(self.Title, "SWATTitle", w/2, 17, highlight_colors.swat, TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 1, line_colors.swat)
	return true
end
