...
PLAYER.DisplayName			= "POLTERGEIST"
PLAYER.ClassDescription 	= "POLTERGEIST, HIDDEN GHOST\nPERMANENT, BUT IMPERFECT CLOAKING"
PLAYER.ClassPros			= {	"PERMANENT CLOAK"}
PLAYER.ClassCons			= {}
...
function PLAYER:Loadout()
	...
	self.Player:SetMaterial("models/shadertest/predator" )

	self.Player:DrawWorldModel(false)
	mdl = self.Player:GetViewModel()
	if mdl:IsValid() then
		mdl:SetMaterial("models/shadertest/predator")
	end
end
...
player_manager.RegisterClass( "player_poltergeist", PLAYER, "player_default" )
