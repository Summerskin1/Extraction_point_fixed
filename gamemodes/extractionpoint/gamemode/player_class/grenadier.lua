...
PLAYER.ClassDescription 	= "GRENADIER, GRENADE SPECIALIST \nACCESS TO LOTS OF GRENADES\nBUT NO PRIMARY WEAPON"
PLAYER.ClassPros			= {	"EXTRA GRENADES"}
PLAYER.ClassCons			= {	"NO PRIMARY WEAPON"}

grenade = {	"weapon_ep_gren_frag",
			"weapon_ep_gren_he",
			"weapon_ep_gren_stun",
			"weapon_ep_gren_rpg"};
			
PLAYER.ClassTeam			= 2
PLAYER.Model				= "models/player/guerilla.mdl"
...
function PLAYER:Loadout()
	...
	self.Player:SetModel("models/player/guerilla.mdl")
end

function PLAYER:GiveGuns()	
	--No primary.
	self.MoveMultiplier = 1
	self:GiveWeapon(table.Random(grenade)) -- grenade
...
player_manager.RegisterClass( "player_grenadier", PLAYER, "player_default" )