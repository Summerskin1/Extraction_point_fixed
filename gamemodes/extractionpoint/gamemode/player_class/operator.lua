...
PLAYER.ClassDescription 	= "OPERATOR, STEALTH CLASS\nGHOSTS CAN'T SEE YOUR POSITION\nGOOD WITH KNIVES AND HEADSHOTS\nGET THE DROP ON GHOSTS FOR MASSIVE DAMAGE"
PLAYER.ClassPros			= {	"GHOSTS CAN'T SEE YOU THROUGH WALLS",
								"BONUS KNIFE AND HEADSHOT DAMAGE",
								"IMMUNE TO GAS GRENADES",
								"INCREASED DAMAGE FROM BEHIND"}
PLAYER.ClassCons			= { "NO GRENADES" }

PLAYER.ClassTeam			= 2
PLAYER.Model				= "models/player/gasmask.mdl"
